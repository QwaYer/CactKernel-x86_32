...
vfs_symlink_entry_t symlink_pool[VFS_SYMLINK_POOL_SIZE];
mutex_t             symlink_mutex;

vfs_mount_t mount_table[VFS_MOUNT_MAX];
int         mount_count = 0;

mutex_t vfs_mutex;   // protects mount_table and symlink_pool
