...
DRIVER_INITFS_DIR     = Cact/drivers/initfs
...
$(BUILD_DIR)/initfs_modblob.o: $(DRIVER_INITFS_DIR)/initfs_modblob.c $(DRIVER_INITFS_DIR)/initfs_modblob.h
	@mkdir -p $(BUILD_DIR)
	gcc $(CFLAGS) -c $< -o $@
